...
<nav>
    ...
    <section>
        ...
        <?php
            ...
            $sql2 = "SELECT Id, IdPracownika, Data, Czas, NazwaFirmy FROM Zlecenie";
            $result = $conn->query($sql2);

            if ($result->num_rows > 0) {
                echo "<h2>Orders:</h2>";
                echo "<table>";
                echo "<tr><th>Order ID</th><th>Employee ID</th><th>Date</th><th>Time</th><th>Company Name</th><th>Actions</th></tr>";
